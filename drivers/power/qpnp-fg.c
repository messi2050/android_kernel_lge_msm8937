...
|| defined(CONFIG_MACH_MSM8940_MH_TMO_US) || defined(CONFIG_MACH_MSM8940_MH_TRF_US) || defined(CONFIG_MACH_MSM8940_MH_GLOBAL_CA) || defined(CONFIG_MACH_MSM8940_MH_LAO_COM)
static int temp_comp[NUMBER_DELTA_TEMP][2] = {
    /* Measured  degree *10 ,  delta degree
     * delta degree = (Measured Temp - FG temp) * 10 */
    {-300, -80},
